...
const wasTranslated = JSON.stringify(translatedFilter).includes('type_persona') && 
                     !JSON.stringify(translatedFilter).includes('b2b_segment');
console.log(`\nSuccess: ${wasTranslated ? '✅' : '❌'}`);

console.log('\n=== Summary ===');
console.log(`The B2B segment mapping issue has been ${wasTranslated ? 'FIXED' : 'NOT FIXED'}`);
console.log('The import path was corrected from "../utils/attribute-mapping.js" to "../utils/attribute-mapping/index.js"');