/**
 * Uniqueness Constraint Error Enhancer
 *
 ...
 * and provides enhanced error message with existing record ID and actionable options.
 */
...
async function enhance(
  ...
  if (!context.recordData) return null;
