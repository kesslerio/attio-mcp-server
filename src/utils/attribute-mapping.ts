 ...
 */
const LEGACY_ATTRIBUTE_MAP: Record<string, string> = {
  // Company attributes
  'Name': 'name',
  'Website': 'website',
  'Industry': 'industry',
 ...
 */
export function translateAttributeNamesInFilters(filters: any, objectType?: string): any {
  ...
  if (translatedFilters.filters && Array.isArray(translatedFilters.filters)) {
    translatedFilters.filters = translatedFilters.filters.map((filter: any) => {
