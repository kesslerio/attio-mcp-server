      ...
      filters: [
        {
          ...
          value: value as Record<string, unknown>, // TODO: Update FilterValue type to accept unknown
        },
      ],
      matchAny: false,
    };
    ...
    filters: [
      {
        ...
        value: processedValue as Record<string, unknown>, // TODO: Update FilterValue type to accept unknown
      },
    ],
    matchAny: false,
  };
