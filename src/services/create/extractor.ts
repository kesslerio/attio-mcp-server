 ...
 *
 * Extracted from legacy MockService to be shared between AttioCreateService and MockCreateService
 ...
 */
export function extractAttioRecord(response: unknown): AttioRecord | null {
 ...
 */
export function assertLooksLikeCreated(record: unknown, context: string): void {
