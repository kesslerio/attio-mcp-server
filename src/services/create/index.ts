...
export { getCreateService, shouldUseMockData, createServiceFactory } from './factory.js';

// Type definitions
export type { CreateService, CreateServiceFactory, EnvironmentDetector } from './types.js';
