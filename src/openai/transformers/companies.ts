...
export const transformCompany = {
  ...
  toSearchResult(company: any): OpenAISearchResult {
    ...
    const name = extractAttributeValue(company.attributes?.name || company.name);
    const domain = extractAttributeValue(company.attributes?.domains || company.domains);
    const description = extractAttributeValue(company.attributes?.description || company.description);
  ...
  toFetchResult(company: any): OpenAIFetchResult {
    ...
    const businessFields = [
      'industry', 'company_size', 'founded_date', 'revenue',
