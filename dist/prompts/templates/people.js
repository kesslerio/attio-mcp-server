...
export const peoplePrompts = [
    {
        ...
        template: 'Create a new person named {{name}}{{#if email}} with email {{email}}{{/if}}{{#if phone}} and phone number {{phone}}{{/if}}{{#if title}} who works as {{title}}{{/if}}{{#if company}} at {{company}}{{/if}}.'
    },
    {
    ...
    },
    {
        ...
        template: 'Update the person with ID {{personId}}{{#if name}} to change their name to {{name}}{{/if}}{{#if email}}, update their email to {{email}}{{/if}}{{#if phone}}, update their phone number to {{phone}}{{/if}}{{#if title}}, and update their job title to {{title}}{{/if}}.'
    },
    {
        ...
        template: 'Add a note titled "{{title}}" with content "{{content}}" to the person with ID {{personId}}.'
    }
];
