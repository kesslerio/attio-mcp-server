...
export const listsPrompts = [
    {
        ...
        parameters: [
            ...
            },
            {
                name: 'objectSlug',
                type: 'string',
                description: 'Object type the list is for (e.g., "companies", "people")',
                required: true,
        ...
        template: 'Create a new {{objectSlug}} list titled "{{title}}"{{#if description}} with description "{{description}}"{{/if}}.'
    },
    {
        ...
        template: 'Add the record with ID {{recordId}} to the list with ID {{listId}}.'
    },
    {
        ...
        template: 'Remove the entry with ID {{entryId}} from the list with ID {{listId}}.'
    },
    {
        ...
        template: 'Check if the record with ID {{recordId}} is in the list with ID {{listId}}.'
    },
    {
        id: 'get-list-entries',
        ...
        template: 'Get {{limit}} entries from the list with ID {{listId}}{{#if offset}}, skipping the first {{offset}} entries{{/if}}.'
    }
];
