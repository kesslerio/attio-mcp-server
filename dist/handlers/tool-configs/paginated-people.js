import { paginatedSearchPeople, paginatedSearchPeopleByCreationDate, paginatedSearchPeopleByModificationDate, paginatedSearchPeopleByLastInteraction, paginatedSearchPeopleByActivity } from "../../objects/paginated-people.js";
/**
 ...
 */
function formatPaginatedPeopleResult(result) {
    ...
    // Format result list
    const resultList = results.map((person) => `- ${person.values?.name?.[0]?.value || 'Unnamed'} (ID: ${person.id?.record_id || 'unknown'})`).join('\n');
...
export const paginatedPeopleToolDefinitions = [
    {
        name: "paginated-search-people",
        description: "Search for people using advanced filtering capabilities with pagination",
        inputSchema: {
            type: "object",
            properties: {
                filters: {
            ...
            properties: {
                dateRange: {
                    ...
                    properties: {
                        start: {
                            type: "string",
                            description: "Start date in ISO format or relative date expression"
                        },
                        end: {
                            type: "string",
    ...
    {
        name: "paginated-search-people-by-modification-date",
        description: "Search for people by their last modification date with pagination",
        inputSchema: {
            type: "object",
            properties: {
                dateRange: {
    ...
    {
        name: "paginated-search-people-by-last-interaction",
        description: "Search for people by their last interaction date with pagination",
        inputSchema: {
            type: "object",
            properties: {
                dateRange: {
...
//# sourceMappingURL=paginated-people.js.map