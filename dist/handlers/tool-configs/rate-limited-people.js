 ...
 */
import { paginatedPeopleToolConfigs, paginatedPeopleToolDefinitions } from './paginated-people.js';
...
export const rateLimitedPeopleToolConfigs = {
    advancedSearch: {
        ...
        handler: withRateLimiting(paginatedPeopleToolConfigs.advancedSearch.handler, 'people-advanced-search')
    },
    searchByCreationDate: {
        ...paginatedPeopleToolConfigs.searchByCreationDate,
        name: "rate-limited-search-people-by-creation-date",
        handler: withRateLimiting(paginatedPeopleToolConfigs.searchByCreationDate.handler, 'people-creation-date')
    },
    searchByModificationDate: {
        ...
        handler: withRateLimiting(paginatedPeopleToolConfigs.searchByModificationDate.handler, 'people-modification-date')
    },
    searchByLastInteraction: {
        ...
        handler: withRateLimiting(paginatedPeopleToolConfigs.searchByLastInteraction.handler, 'people-last-interaction')
    },
    searchByActivity: {
        ...paginatedPeopleToolConfigs.searchByActivity,
        name: "rate-limited-search-people-by-activity",
        handler: withRateLimiting(paginatedPeopleToolConfigs.searchByActivity.handler, 'people-activity')
    }
};
/**
 * Rate-limited versions of paginated people tool definitions
 */
export const rateLimitedPeopleToolDefinitions = paginatedPeopleToolDefinitions.map(def => ({
    ...def,
    name: `rate-limited-${def.name}`,
    description: `${def.description} (with rate limiting applied)`
}));
//# sourceMappingURL=rate-limited-people.js.map