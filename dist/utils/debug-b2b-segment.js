...
console.log = (...args) => {
    if (args[0]?.includes?.('b2b_segment') ||
...
async function debugB2BSegmentMapping() {
    try {
        ...
        const translatedFilters = translateAttributeNamesInFilters(filters, ResourceType.COMPANIES);
        console.log("[TEST] Translated filters:", JSON.stringify(translatedFilters, null, 2));
        // Test the search
...
//# sourceMappingURL=debug-b2b-segment.js.map