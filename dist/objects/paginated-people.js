 ...
 */
export async function paginatedSearchPeople(filters, page = 1, pageSize = 20) {
    try {
 ...
 * @returns Paginated response with matching people
 */
export async function paginatedSearchPeopleByCreationDate(dateRange, page = 1, pageSize = 20) {
    try {
 ...
 * @returns Paginated response with matching people
 */
export async function paginatedSearchPeopleByModificationDate(dateRange, page = 1, pageSize = 20) {
    try {
        // Validate and normalize inputs
        const validatedDateRange = validateDateRange(dateRange);
        const validPage = validateNumericParam(page, 'page', 1);
 ...
 * @returns Paginated response with matching people
 */
export async function paginatedSearchPeopleByLastInteraction(dateRange, interactionType, page = 1, pageSize = 20) {
    try {
        // Validate and normalize inputs
        const validatedDateRange = validateDateRange(dateRange);
        const validPage = validateNumericParam(page, 'page', 1);
 ...
 * @returns Paginated response with matching people
 */
export async function paginatedSearchPeopleByActivity(activityFilter, page = 1, pageSize = 20) {
    try {
        // Validate and normalize inputs
