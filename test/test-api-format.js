...
async function testApiFormat() {
  ...
  try {
    ...
    try {
      ...
      console.log('New services value:', JSON.stringify(updateResponse.data.data.values.services, null, 2));
      ...
      try {
        ...
        console.error('Full error:', JSON.stringify(error2.response?.data, null, 2));
      }
    }
