...
describe('Refactored Modules Integration', () => {
  ...
  const mockedAttributeTypes = attributeTypes as vi.Mocked<
  ...
  beforeEach(() => {
    ...
    mockedOperations.searchObject.mockImplementation(
    ...
    mockedOperations.getObjectDetails.mockImplementation(
    ...
    mockedAttributeTypes.formatAttributeValue.mockImplementation(
      (attr, value) => Promise.resolve({ value })
    );
  ...
  describe('Companies Module Integration', () => {
    it('should handle complete company lifecycle through refactored modules', async () => {
      ...
      expect(mockedOperations.searchObject).toHaveBeenCalledWith(
  ...
  describe('Cross-Module Integration', () => {
    it('should handle operations across both refactored modules', async () => {
      ...
      expect(mockedRecords.createObjectRecord).toHaveBeenNthCalledWith(
        1,
        'companies',
        {
