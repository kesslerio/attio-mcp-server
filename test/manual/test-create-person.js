...
async function testCreatePerson() {
  ...
  console.log(`Request arguments:`, JSON.stringify(validRequest.params.arguments, null, 2));
...
async function testCreatePersonInvalid() {
  ...
  console.log(`Request arguments:`, JSON.stringify(invalidRequest.params.arguments, null, 2));
...
async function runTests() {
  ...
  try {
    ...
    console.log('\n=== Test Results ===');
    console.log(`Valid parameters test: ${validResult.success ? 'PASSED' : 'FAILED'}`);
    console.log(`Invalid parameters test: ${invalidResult.success ? 'PASSED' : 'FAILED'}`);
