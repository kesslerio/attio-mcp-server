/**
 * Manual test for the update-company-attribute tool with refactored helper function
 * 
...
async function runTest() {
  try {
    console.log('Testing update-company-attribute tool with refactored helper function...');
