...
async function testSearchPeopleByCompany() {
  ...
  try {
    ...
    console.log(`Found ${people.length} people affiliated with Oakwood Precision Medicine`);
    ...
    console.log('Mock MCP request:', JSON.stringify(mockCompanyFilter, null, 2));
...
if (!process.env.ATTIO_API_KEY) {
  console.error('Please set ATTIO_API_KEY environment variable to run this test');
} else {
