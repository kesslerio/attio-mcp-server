...
import { E2ETaskFactory, type E2ETestTask } from '../utils/test-data.js';
    ...
    demo: (): E2ETestTask =>
      E2ETaskFactory.create({
        ...
        content:
          'Schedule and conduct a product demonstration for the prospect',
        priority: 'high',
        status: 'open',
      }),

    proposal: (): E2ETestTask =>
      E2ETaskFactory.create({
        title: 'E2E Prepare sales proposal',
        content:
          'Create customized sales proposal based on discovery call findings',
        priority: 'medium',
        status: 'in_progress',
      }),

    contract: (): E2ETestTask =>
      E2ETaskFactory.create({
   ...
   */
  customerSuccess: {
    onboarding: (): E2ETestTask =>
      E2ETaskFactory.create({
        title: 'E2E Complete customer onboarding',
        content:
          'Guide new customer through onboarding process and initial setup',
        priority: 'high',
        status: 'in_progress',
      }),
    ...
    checkIn: (): E2ETestTask =>
      E2ETaskFactory.create({
        ...
        content:
          'Conduct quarterly review meeting with key customer stakeholders',
        priority: 'medium',
        status: 'scheduled',
      }),
    ...
    renewal: (): E2ETestTask =>
      E2ETaskFactory.create({
        ...
        content:
          'Initiate contract renewal discussion 90 days before expiration',
        priority: 'high',
        status: 'open',
      }),
  },
  ...
  admin: {
    ...
    reporting: (): E2ETestTask =>
      E2ETaskFactory.create({
        title: 'E2E Generate monthly report',
        content:
          'Compile and distribute monthly sales and marketing metrics report',
        priority: 'medium',
        status: 'recurring',
      }),
    ...
    cleanup: (): E2ETestTask =>
      E2ETaskFactory.create({
        ...
        content:
          'Remove duplicate records and update outdated contact information',
        priority: 'low',
        status: 'scheduled',
      }),
  },
  ...
  development: {
    ...
    feature: (): E2ETestTask =>
      E2ETaskFactory.create({
        ...
        content:
          'Develop new feature based on customer feedback and requirements',
        priority: 'medium',
        status: 'open',
      }),
...
export const taskScenarios = {
  ...
  customerLifecycle: () => ({
    ...
    ongoing: [
      ...
      E2ETaskFactory.create({
        ...
        content:
          'Review customer success metrics and identify improvement opportunities',
        priority: 'medium',
        status: 'recurring',
      }),
    ],
  ...
  priorityTesting: () => ({
    critical: E2ETaskFactory.createHighPriority({
      ...
      content:
        'Investigate and resolve critical system outage affecting all customers',
      status: 'in_progress',
    }),
    high: [
      taskFixtures.sales.followUp(),
...
export const edgeCaseTasks = {
  ...
  unicode: (): E2ETestTask =>
    E2ETaskFactory.create({
      ...
      content:
        'Task with Unicode characters: 中文 العربية русский 日本語 한국어 🌍',
    }),
  ...
  farFuture: (): E2ETestTask => {
    ...
    return E2ETaskFactory.create({
      ...
      content:
        'This task has a due date far in the future for testing long-term planning',
