...
export const edgeCaseCompanies = {
   ...
   */
  specialCharacters: (): E2ETestCompany =>
    E2ECompanyFactory.create({
   ...
   */
  longFields: (): E2ETestCompany =>
    E2ECompanyFactory.create({
      name: 'E2E Very Long Company Name That Exceeds Normal Length Expectations For Testing Purposes',
      description:
        'This is a very long description that contains multiple sentences and goes on for quite some time to test how the system handles lengthy text fields. It includes various details about the company, its mission, vision, values, and extensive background information that might be provided in real-world scenarios. The purpose is to ensure that the system can handle and properly store, retrieve, and display longer text content without issues.',
      industry:
        'Advanced Technology Solutions & Digital Transformation Services',
    }),

  /**
   * Company with Unicode and emoji
   */
  unicode: (): E2ETestCompany =>
    E2ECompanyFactory.create({
      name: 'E2E 🚀 Unicode Company 测试 公司 🏢',
      description:
        'Company with Unicode characters: 中文 العربية русский 日本語 한국어 🌍',
