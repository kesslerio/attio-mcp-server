...
export const testDataGenerator = {
  companies: {
    ...
    advanced: () => CompanyFactory.create({
  ...
  people: {
    ...
    withCompany: (companyId: string) => PersonFactory.create({ company: companyId })
  },
  lists: {
  ...
  tasks: {
    ...
    highPriority: () => TaskFactory.create({ priority: 'high', status: 'pending' })
  },
  notes: {
