...
export const edgeCaseLists = {
   ...
   */
  longFields: (): E2ETestList =>
    E2EListFactory.create({
      name: 'E2E Very Long List Name That Exceeds Normal Length Expectations For Testing Purposes',
      description:
        'This is a very long description that contains multiple sentences and goes on for quite some time to test how the system handles lengthy text fields. It includes various details about the list purpose, criteria, and extensive background information that might be provided in real-world scenarios.',
    }),
  ...
  unicode: (): E2ETestList =>
    E2EListFactory.create({
      ...
      description:
        'List with Unicode characters: 中文 العربية русский 日本語 한국어 🌍',
    }),
...
export const listCategories = {
  sales: ['prospects', 'leads', 'opportunities', 'customers', 'champions'],
