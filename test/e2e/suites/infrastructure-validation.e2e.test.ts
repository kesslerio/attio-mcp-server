...
describe.skipIf(
  ...
  describe('Test Data Factory Validation', () => {
    it('should create valid test company data', () => {
      ...
      // Note: website field intentionally removed to avoid collision with domain -> domains mapping
    ...
    it('should create valid test person data', () => {
      ...
      // The config specifies testEmailDomain as "@e2e-test.example.com" but the factory
      // generates emails with just "example.com" domain. Check for the actual domain.
      expect(person.email_addresses[0]).toContain('@example.com');
    ...
    it('should validate test data integrity', () => {
      ...
      expect(companyValidation).toBe(true);
      expect(personValidation).toBe(true);
