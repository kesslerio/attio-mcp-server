...
console.log(
  'getAttributeSlug("b2b_segment", "companies"):',
  getAttributeSlug('b2b_segment', 'companies')
);
console.log(
  'getAttributeSlug("B2B Segment", "companies"):',
  getAttributeSlug('B2B Segment', 'companies')
);
...
const translatedClaudeFilter = translateAttributeNamesInFilters(
  claudeRequestFilter,
  'companies'
);
console.log(
  'Claude original filter:',
  JSON.stringify(claudeRequestFilter, null, 2)
);
console.log(
  'Translated filter:',
  JSON.stringify(translatedClaudeFilter, null, 2)
);
...
console.log(
  'Actual mapping result for b2b_segment:',
  getAttributeSlug('b2b_segment', 'companies')
);
