 ...
 */
import { getListEntries } from '../dist/objects/lists.js';
import { transformFiltersToApiFormat } from '../dist/utils/record-utils.js';
...
function testFilterTransformation() {
  ...
  console.log(JSON.stringify(transformFiltersToApiFormat(basicFilter), null, 2));
  
  console.log("\nComplex OR filter transformed:");
  console.log(JSON.stringify(transformFiltersToApiFormat(complexOrFilter), null, 2));
  
  console.log("\nComplex AND filter transformed:");
  console.log(JSON.stringify(transformFiltersToApiFormat(complexAndFilter), null, 2));
}
