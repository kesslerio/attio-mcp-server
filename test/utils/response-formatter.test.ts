...
describe('response-formatter', () => {
  ...
  describe('formatListResponse', () => {
    ...
    it('should include pagination info if provided', () => {
      ...
      const result = formatListResponse('Test Items', items, formatter, pagination);
  ...
  describe('formatRecordResponse', () => {
    it('should format a single record', () => {
      ...
      const formatter = (r: any) => `Name: ${r.name}\nID: ${r.id}\nValue: ${r.value}`;
  ...
  describe('formatErrorResponse', () => {
    it('should create a standardized error response', () => {
      const result = formatErrorResponse('Something went wrong', 500, 'internal_error');
    ...
    it('should include details if provided', () => {
      ...
      const result = formatErrorResponse('Validation failed', 400, 'validation_error', details);
