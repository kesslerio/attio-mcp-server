...
export class UniversalMockService {
            ...
            values: {
                ...
                domains: mockCompany.values.domains ?
                    (Array.isArray(mockCompany.values.domains)
                        ...
                        : [{ value: mockCompany.values.domains }]) : [{ value: `${mockCompany.id.company_id}.example.com` }],
                ...
                ...Object.fromEntries(Object.entries(companyData)
    ...
    static async createPerson(personData) {
        ...
        return {
            ...
            values: {
                ...
                // Pass through any additional fields with proper wrapping
                ...Object.fromEntries(Object.entries(personData)
    ...
    static async createTask(taskData) {
        if (!this.shouldUseMockData()) {
            ...
            try {
                ...
                return (await createTask(taskData.content, {
        ...
        const attioRecord = {
            ...
            values: {
                ...
                // Pass through any additional fields with proper wrapping
                ...Object.fromEntries(Object.entries(taskData)
    ...
    static async updateTask(taskId, updateData) {
        if (!this.shouldUseMockData()) {
            ...
            try {
                ...
                return (await updateTask(taskId, {
                    ...
                    recordIds: updateData.recordIds,
                }));
            }
            catch (error) {
        ...
        if (updateData.assigneeId && !isValidId(updateData.assigneeId)) {
        ...
        const taskContent = updateData.content ||
            updateData.title ||
        ...
        const attioRecord = {
            ...
            values: {
                ...
                assignee: mockTask.assignee ? [{ value: mockTask.assignee.id }] : undefined,
                // Pass through any additional fields with proper wrapping
                ...Object.fromEntries(Object.entries(updateData)
                    .filter(([key]) => !['content', 'title', 'status', 'due_date', 'assignee'].includes(key))
                    .map(([key, value]) => [
                    key,
                    Array.isArray(value) ? value : [{ value: String(value) }],
...
//# sourceMappingURL=UniversalMockService.js.map