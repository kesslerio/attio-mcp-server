...
export class PersonMockFactory implements MockFactory<AttioRecord> {
   ...
   */
  static createMultiple(count: number, overrides: MockPersonOptions = {}): AttioRecord[] {
   ...
   */
  static createWithCompany(companyId: string, overrides: MockPersonOptions = {}): AttioRecord {
    return this.create({
      ...overrides,
      company: companyId
    });
