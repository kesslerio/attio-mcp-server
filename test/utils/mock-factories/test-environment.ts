...
export function getTestContext():
  ...
  if (
    ...
    (global as any).__filename?.includes('/test/e2e/')
  ) {
    return 'e2e';
  }
  ...
  if (
    ...
    (global as any).__filename?.includes('/test/integration/')
  ) {
    return 'integration';
  }
...
export const TestEnvironment = {
   ...
   */
  get isUnit() {
    return getTestContext() === 'unit';
  },
  get isIntegration() {
    return getTestContext() === 'integration';
  },
  get isE2E() {
    return getTestContext() === 'e2e';
  },
  get isProduction() {
    return getTestContext() === 'production';
  },
