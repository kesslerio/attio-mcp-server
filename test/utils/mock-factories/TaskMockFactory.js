...
export class TaskMockFactory {
     ...
     */
    static createWithId(identifier, overrides = {}) {
        ...
        if (overrides.assignee_id || overrides.assignees) {
            ...
            if (overrides.assignees && Array.isArray(overrides.assignees)) {
                ...
                baseTask.assignees = [overrides.assignee_id];
            }
        }
     ...
     */
    static createWithAssignee(assigneeId, overrides = {}) {
        return this.create({
            ...overrides,
     ...
     */
    static createWithLinkedRecords(recordIds, overrides = {}) {
     ...
     */
    static generateFutureDueDate(offset = 0) {
...
//# sourceMappingURL=TaskMockFactory.js.map