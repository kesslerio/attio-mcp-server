...
describe('Enhanced Company Validator', () => {
  ...
  describe('validateAttributeTypes', () => {
    it('should validate and convert attributes based on their types', async () => {
      ...
      expect(getAttributeTypeInfo).toHaveBeenCalledWith('companies', 'employees');
      expect(getAttributeTypeInfo).toHaveBeenCalledWith('companies', 'is_active');
      expect(getAttributeTypeInfo).toHaveBeenCalledWith('companies', 'founded_date');
      expect(getAttributeTypeInfo).toHaveBeenCalledWith('companies', 'description');
    });
    ...
    it('should proceed with original value if type info cannot be determined', async () => {
      ...
      expect(getAttributeTypeInfo).toHaveBeenCalledWith('companies', 'custom_field');
    });
  });
  ...
  describe('validateCreate', () => {
    it('should validate required fields and enhance with type validation', async () => {
      ...
      expect(CompanyValidator.validateAttributeTypes).toHaveBeenCalledWith(attributes);
    });
    ...
    it('should throw MissingCompanyFieldError if name is missing', async () => {
      ...
      await expect(CompanyValidator.validateCreate(attributes))
        .rejects
        .toThrow(MissingCompanyFieldError);
  ...
  describe('validateUpdate', () => {
    it('should validate company ID and enhance with type validation', async () => {
      ...
      const result = await CompanyValidator.validateUpdate(companyId, attributes);
    ...
    it('should throw InvalidCompanyDataError if company ID is invalid', async () => {
      ...
      await expect(CompanyValidator.validateUpdate('', attributes))
        .rejects
        .toThrow(InvalidCompanyDataError);
