...
console.log(`Testing domain validation for "${possibleDomain}":`, isValidDomain(possibleDomain));
...
console.log(`extractDomain("${possibleDomain}"):`, extractDomainManual(possibleDomain));
