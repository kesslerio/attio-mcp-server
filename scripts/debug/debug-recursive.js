...
const result2 = PeopleDataNormalizer.normalizeEmails(
  testObject.email_addresses
);
...
console.log(
  'email_addresses is array:',
  Array.isArray(testObject.email_addresses)
);
...
if (testObject.email_address) {
  ...
  console.log(
    'Recursively calling with:',
    JSON.stringify(testObject.email_addresses)
  );
  const recursiveResult = PeopleDataNormalizer.normalizeEmails(
    testObject.email_addresses
  );
