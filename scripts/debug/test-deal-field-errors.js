...
const testCases = [
  {
    ...
    expectedSuggestion: 'Deals do not have a "description" field. Available fields: name, stage, value, owner, associated_company, associated_people'
  },
  {
    ...
    expectedSuggestion: 'Deals do not have a built-in probability field. Consider using custom fields or tracking probability in stage names'
  },
  {
    ...
    expectedSuggestion: 'Deals do not have a built-in source field. Consider using custom fields to track deal sources'
  },
  {
    ...
    expectedSuggestion: 'Deals do not have a built-in close date field. Consider using a custom field or tracking this separately'
  },
  {
    name: "Deal with tags",
    input: {
    ...
    expectedSuggestion: 'Deals do not have a built-in tags field. Consider using custom fields or categories'
  },
  {
    ...
    expectedSuggestion: 'Use "associated_people" to link contacts/people to deals'
  },
  {
    ...
    expectedSuggestion: 'Deal notes should be created separately using the notes API after the deal is created'
  },
  {
    ...
    expectedSuggestion: 'Deal types are not built-in. Use stages or custom fields to categorize deals'
  },
  {
    ...
    expectedSuggestion: 'Currency is set automatically based on workspace settings. Just provide a numeric value for the deal amount'
  }
];
