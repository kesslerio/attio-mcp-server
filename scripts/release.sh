...
echo "[ ] Watch the GitHub tag workflows complete for release + npm trusted publishing"
...
echo "[ ] If npm publish fails, confirm npm Trusted Publisher is configured for kesslerio/attio-mcp-server and .github/workflows/publish-mcp-registry.yml"
echo ""
