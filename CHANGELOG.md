...
- **Date-parser unit tests no longer fail on non-UTC hosts** — vitest default and offline configs pin `TZ=UTC` so hardcoded week/month calendar fixtures stay stable under Asia/Tokyo and similar offsets (#1253)
