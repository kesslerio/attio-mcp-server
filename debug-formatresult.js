...
import { searchRecordsConfig } from './dist/handlers/tool-configs/universal/core-operations.js';
...
console.log('\n=== TEST EXPECTATIONS ===');
console.log('Should contain "Found 2 companies":', formatted.includes('Found 2 companies'));
console.log('Should contain "1. Test Company":', formatted.includes('1. Test Company'));
console.log('Should contain "2. Another Company":', formatted.includes('2. Another Company'));
...
try {
  ...
  const dispatcherFormatted = searchRecordsConfig.formatResult(mockResults, args?.resource_type, args?.info_type);
  console.log('Dispatcher format (3 args) - Type:', typeof dispatcherFormatted);
  console.log('Dispatcher format (3 args) - Content preview:', dispatcherFormatted.substring(0, 100));
} catch (error) {
  ...
  try {
    ...
    console.log('Dispatcher fallback (1 arg) - Type:', typeof fallbackFormatted);
    console.log('Dispatcher fallback (1 arg) - Content preview:', fallbackFormatted.substring(0, 100));
  } catch (fallbackError) {
