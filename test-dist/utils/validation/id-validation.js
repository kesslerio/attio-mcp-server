 ...
 */
export function validateRecordId(id, _resourceType) {
 ...
 */
export function validateRecordIds(ids, resourceType) {
 ...
 */
export function areAllIdsValid(ids) {
 ...
 */
export function generateIdCacheKey(resourceType, id) {
 ...
 */
export function isIdFormatError(error) {
    if (!error)
        return false;
    const errorMessage = error.message || error.toString() || '';
    const lowerMessage = errorMessage.toLowerCase();
    return (lowerMessage.includes('invalid id') ||
