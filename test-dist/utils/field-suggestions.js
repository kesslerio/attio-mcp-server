 ...
 */
export function findSimilarOptions(input, validOptions, maxSuggestions = 3, threshold = 3) {
    ...
    if (suggestions.length === 0) {
        const substringMatches = validOptions.filter((option) => option.toLowerCase().includes(normalizedInput) ||
 ...
 */
export function generateFieldSuggestionMessage(fieldName, validFields, context) {
 ...
 */
export function generateEnumSuggestionMessage(value, validValues, fieldName) {
 ...
 */
export function generateReadOnlyFieldMessage(fieldName, operation = 'update') {
 ...
 */
export function generateResourceTypeSuggestionMessage(resourceType, validTypes) {
 ...
 */
export function validateFieldWithSuggestions(fieldName, validFields, readOnlyFields = [], operation = 'update') {
