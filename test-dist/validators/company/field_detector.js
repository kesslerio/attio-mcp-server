...
export function isBooleanFieldByName(fieldName) {
...
export async function processFieldValue(fieldName, value) {
    ...
    try {
        ...
        if (isBooleanFieldByName(fieldName) &&
            (typeof value === 'string' || typeof value === 'number')) {
            try {
                return convertToBoolean(value);
            }
        ...
        if (fieldName.toLowerCase().includes('categories') &&
            typeof value === 'string') {
            return [value];
        }
    }
    ...
    if (Array.isArray(value)) {
        const processedArray = value.filter((item) => typeof item === 'string' ||
            typeof item === 'number' ||
            typeof item === 'boolean');
