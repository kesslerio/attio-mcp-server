 ...
 */
export function validateAttributeValue(attributeName, value, expectedType) {
 ...
 * // Returns: { valid: true, convertedValue: true }
 */
function validateBooleanValue(attributeName, value) {
 ...
 */
function validateNumberValue(attributeName, value) {
 ...
 */
function validateStringValue(attributeName, value) {
 ...
 * // Returns: { valid: true, convertedValue: '2023-01-15T12:30:00.000Z' }
 */
function validateDateValue(attributeName, value) {
 ...
 */
function validateArrayValue(attributeName, value) {
 ...
 */
function validateObjectValue(attributeName, value) {
 ...
 */
function validateSelectValue(attributeName, value) {
 ...
 */
function validateRecordReferenceValue(attributeName, value) {
