        ...
        try {
            ...
            if (!filters) {
                if (process.env.NODE_ENV === 'development') {
                    console.error('[advancedSearchObject] No filters provided, using default parameters only');
                }
                return body;
            }
            // Import validation utilities dynamically to avoid circular dependencies
            const { validateFilters } = await import('../../utils/filters/validation-utils.js');
